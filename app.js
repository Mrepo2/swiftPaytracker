...
app.get("/admin/seti", async(req, res)=>{
  let perPage = 12;
...
app.get("/transId/progress/swiftPay/:id", async (req, res)=>{
  try {
...
//DB config
const db ='mongodb+srv://marcelpolocha1:081358pius@cluster0.f9a85hv.mongodb.net/swiftpay';
// connect to mongodb
mongoose.connect(db)
.then(()=>{
